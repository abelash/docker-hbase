...
build:
	docker build -t albelash/hbase-base:$(current_branch) ./base
	docker build -t albelash/hbase-master:$(current_branch) ./hmaster
	docker build -t albelash/hbase-regionserver:$(current_branch) ./hregionserver
